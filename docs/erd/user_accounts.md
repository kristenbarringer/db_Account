...
| user_name | nvarchar(200) |  | true |  |  | the user name of the user, Data type = nvarchar(200), Nullable = Yes |
| first_name | nvarchar(50) | ('Tracking') | false |  |  | the first name of the user, Data type = nvarchar(50), Nullable = No |
| last_name | nvarchar(50) | ('User') | false |  |  | the last name of the user, Data type = nvarchar(50), Nullable = No |
| email_address | nvarchar(300) |  | false |  |  | the email address, Data type = nvarchar(300), Nullable = No |
...
| title | nvarchar(200) |  | true |  |  | the job title of the user, Data type = nvarchar(200), Nullable = Yes |
| landing_page | nvarchar(55) | ('DEFAULT') | false |  |  | the page on the UI where the user should land when signing on to the website, Data type = nvarchar(55), Nullable = No |
| object_id | nvarchar(50) |  | true |  |  | the Microsoft Entra ID for the user, Data type = nvarchar(50), Nullable = Yes |
| role_rid | bigint | ((1)) | true |  | [role](role.md) | References column role_rid on table role, Data type = bigint, Nullable = Yes, References = [dbo].[role].[role_rid] |
